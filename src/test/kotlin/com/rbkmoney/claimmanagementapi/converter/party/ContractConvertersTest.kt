...
class ContractConvertersTest {
    ...
    fun payoutToolModificationUnitThriftRandomConverterTest() {
        ...
        if ((thriftPayoutToolModificationUnit.getModification().isSetCreation && !thriftPayoutToolModificationUnit.getModification().creation.toolInfo.isSetDummyAccount) || (thriftPayoutToolModificationUnit.getModification().isSetInfoModification && !thriftPayoutToolModificationUnit.getModification().infoModification.isSetDummyAccount)
        ) {
